...
use HotelBundle\Entity\Invoice;
...
class InvoiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $invoices = $em->getRepository('HotelBundle:Invoice')->findAll();

        return $this->render('@Hotel/invoice/index.html.twig', array(
            'invoices' => $invoices,
        ));
    }
    ...
    {
        $invoice = new Invoice();
        $form = $this->createForm('HotelBundle\Form\InvoiceType', $invoice);
        ...
        return $this->render('@Hotel/invoice/new.html.twig', array(
            'invoice' => $invoice,
    ...
    public function showAction(Invoice $invoice)
    {
        ...
        return $this->render('@Hotel/invoice/show.html.twig', array(
            'invoice' => $invoice,
    ...
    {
        $deleteForm = $this->createDeleteForm($invoice);
        $editForm = $this->createForm('HotelBundle\Form\InvoiceType', $invoice);
        ...
        return $this->render('@Hotel/invoice/edit.html.twig', array(
            'invoice' => $invoice,

...
use HotelBundle\Entity\Facility;
...
class FacilityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $facilities = $em->getRepository('HotelBundle:Facility')->findAll();

        return $this->render('@Hotel/facility/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('HotelBundle\Form\FacilityType', $facility);
        ...
        return $this->render('@Hotel/facility/new.html.twig', array(
            'facility' => $facility,
    ...
    public function showAction(Facility $facility)
    {
        ...
        return $this->render('@Hotel/facility/show.html.twig', array(
            'facility' => $facility,
    ...
    {
        $deleteForm = $this->createDeleteForm($facility);
        $editForm = $this->createForm('HotelBundle\Form\FacilityType', $facility);
        ...
        return $this->render('@Hotel/facility/edit.html.twig', array(
            'facility' => $facility,

...
class SeasonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $seasons = $em->getRepository('HotelBundle:Season')->findAll();

        return $this->render('@Hotel/season/index.html.twig', array(
            'seasons' => $seasons,
        ));
    }
    ...
    {
        $season = new Season();
        $form = $this->createForm('HotelBundle\Form\SeasonType', $season);
        ...
        return $this->render('@Hotel/season/new.html.twig', array(
            'season' => $season,
    ...
    public function showAction(Season $season)
    {
        ...
        return $this->render('@Hotel/season/show.html.twig', array(
            'season' => $season,
    ...
    {
        $deleteForm = $this->createDeleteForm($season);
        $editForm = $this->createForm('HotelBundle\Form\SeasonType', $season);
        ...
        return $this->render('@Hotel/season/edit.html.twig', array(
            'season' => $season,

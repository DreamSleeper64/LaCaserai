...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $media = $em->getRepository('HotelBundle:Media')->findAll();

        return $this->render('@Hotel/media/index.html.twig', array(
            'media' => $media,
        ));
    }
    ...
    {
        $medium = new Media();
        $form = $this->createForm('HotelBundle\Form\MediaType', $medium);
        ...
        return $this->render('@Hotel/media/new.html.twig', array(
            'medium' => $medium,
    ...
    public function showAction(Media $medium)
    {
        ...
        return $this->render('@Hotel/media/show.html.twig', array(
            'medium' => $medium,
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('HotelBundle\Form\MediaType', $medium);
        ...
        return $this->render('@Hotel/media/edit.html.twig', array(
            'medium' => $medium,

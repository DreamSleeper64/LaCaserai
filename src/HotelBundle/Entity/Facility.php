 ...
 * @ORM\Entity(repositoryClass="HotelBundle\Repository\FacilityRepository")
 */
class Facility
{
    /**
    ...
    /**
     * One facility has many Images
     *
     * @ORM\OneToMany(targetEntity="HotelBundle\Entity\Media", mappedBy="facility")
     */
    private $media;
